...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center h4">
        <p class="para1">Find students' details here</p>

        <form action="search.php" method="post" class="d-flex form-margin">
            <input type="text" name="stu_id" placeholder="Enter Student ID" required class="form-control me-4">
            <input type="password" name="password" placeholder="Password" required class="form-control me-4">
            <input type="submit" value="Search" class="btn btn-primary">
        </form>
    </div>
    <div class="h4"><p>Facilities Provided by Us</p></div>
    <div class="box-container">

        <div class="box">
            <div class="ímage">
                <img src="images/scholarship.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/counciling.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/laboratory.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/sport.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/on campus housing.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/computer labs.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/dining.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/classroom.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/clubs.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/health.png" class="img-fluid" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="ímage">
                <img src="images/language.png" class="img-fluid" alt="">
            </div>
            <div class="content">
